...
//            IpAddress.setText(intent.getStringExtra(Constants.IP_ADDRESS));
//            IpPort.setText(intent.getStringExtra(Constants.IP_PORT));
//
    ...
    class RetrieveFeedTask extends AsyncTask<String, Void, String > {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                e.printStackTrace();
                Toast.makeText(EnterIp.this, "Check Network Connection", Toast.LENGTH_LONG).show();
            }
